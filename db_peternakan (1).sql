...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2026 at 01:46 PM
...
(13, 'Domba', '25-40 kg)', 4500000.00, 9, 'hewan-1767944326959.jpg', 'aqiqah', 0, NULL);
...
INSERT INTO `konfigurasi_notifikasi` (`id`, `user_id`, `email_notif`, `inapp_notif`, `notify_pembayaran`, `notify_pengiriman`, `notify_promosi`, `notify_stok`, `notify_login`) VALUES
(6, 5, 1, 1, 1, 1, 0, 0, 1);
...
(2, 13, '2026-01-09', 'Sehat', 'Pemberian Vaksin', 'atat', NULL, '2026-01-09 12:09:15');
...
(72, 'Pesanan Baru Masuk', 'Order #2: Domba (1 ekor)', 'info', 0, '2026-01-09 09:12:05', NULL, 'admin'),
(73, 'Pesanan Baru Masuk', 'Order #3: Domba (1 ekor)', 'info', 0, '2026-01-09 09:13:25', NULL, 'admin'),
(74, 'Pesanan Baru Masuk', 'Order #4: Domba (1 ekor)', 'info', 0, '2026-01-09 09:18:07', NULL, 'admin'),
(75, 'Pembayaran Masuk', 'Order #4 mengupload bukti bayar.', 'pembayaran', 0, '2026-01-09 09:18:13', NULL, 'admin'),
(76, 'Pesanan Baru Masuk', 'Order #5: Domba (2 ekor)', 'info', 0, '2026-01-09 09:18:42', NULL, 'admin'),
(77, 'Pesanan Baru Masuk', 'Order #6: Domba (1 ekor)', 'info', 0, '2026-01-09 09:31:47', NULL, 'admin'),
(78, 'Pesanan Baru', 'Order #7: Domba', 'info', 0, '2026-01-09 09:42:41', NULL, 'admin'),
(79, 'Pesanan Baru', 'Order #8: Domba', 'info', 0, '2026-01-09 12:11:43', NULL, 'admin'),
(80, 'Login Berhasil', 'Akun Anda baru saja login.', 'info', 0, '2026-01-09 12:18:16', 5, 'pelanggan'),
(81, 'Login Berhasil', 'Akun Anda baru saja login.', 'info', 0, '2026-01-09 12:40:31', 5, 'pelanggan'),
(82, 'Login Berhasil', 'Akun Anda baru saja login.', 'info', 0, '2026-01-09 12:44:11', 5, 'pelanggan');
...
CREATE TABLE `pemesanan` (
  ...
  `lacak_distribusi` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 'yaya12', 'yasya123@gmail.com', '$2b$08$JldgrLUrXOnwXecL6On9weHj7BiKigmUE.xC0oYSRKDrObzKWnjiS', '0987654321', 'qawsedfgh', 'pelanggan', '2026-01-06 07:04:55', NULL, NULL),
